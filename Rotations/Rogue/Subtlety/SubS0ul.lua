    ...
    local function actionList_Defensive()
        if useDefensive() then
            if br.isChecked("Auto Defensive Unavoidables") then
                ...
                if bossID == 162693 and isCastingSpell(320788, "boss1") and br.GetUnitIsUnit("player", br._G.UnitTarget("boss1")) and br.isChecked("Cloak Unavoidables") then
                ...
                if bossID == 162693 and isCastingSpell(321894, "boss1") and br.GetUnitIsUnit("player", br._G.UnitTarget("boss1")) then
                    if cast.vanish("player") then return true end
                end
                --Powder Shot (2nd boss freehold)
                local bossID = br.GetObjectID("boss1")
                if bossID == 126848 and isCastingSpell(256979, "target") and br.GetUnitIsUnit("player", br._G.UnitTarget("target")) then
                ...
                if bossID == 126832 and isCastingSpell(256106, "boss1") and br.getFacing("boss1", "player") then
                    if cast.feint("player") then return true end
                end
                --Spit gold (1st boss KR)
                if bossID == 135322 and isCastingSpell(265773, "boss1") and br.GetUnitIsUnit("player", br._G.UnitTarget("boss1")) and br.isChecked("Cloak Unavoidables") then
                    if cast.cloakOfShadows("player") then return true end
                end
                ...
                if (bossID == 133944 or br.GetObjectID("boss2") == 133944) and (isCastingSpell(263257, "boss1") or isCastingSpell(263257, "boss2")) then
