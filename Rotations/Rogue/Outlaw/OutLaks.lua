...
actionList.dps = function()
    ...
    if mode.vanish == 1 and not stealth and cast.able.vanish() and echoStealth() and getCombatTime() > 4 or br.isBoss() then
        if cast.vanish() then
            return true
        end
    end
        ...
        if (mode.cooldown == 1 and br.isChecked("Level 90 talent row") or not br.isChecked("Level 90 talent row")) then
            if getCombatTime() > 2 and br.getFacing("player", dynamic_target_melee, 45) then
        ...
        if (mode.cooldown == 1 and br.isChecked("Adrenaline Rush") or not br.isChecked("Adrenaline Rush")) and getCombatTime() > 2 or br.isBoss() then
    ...
    if br.isChecked("Use Trinkets") then
        ...
        if (_G.GetInventoryItemID("player", 13) == 184016 or _G.GetInventoryItemID("player", 14) == 184016)
                and br.canUseItem(184016) and getCombatTime() > 5 then
            br.useItem(184016)
        end
        --darkmoon trinket
