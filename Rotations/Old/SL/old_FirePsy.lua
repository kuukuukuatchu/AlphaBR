...
--------------------
    ...
    -- Action List - Defensive
        ...
        -- Blazing Barrier
                if br.isChecked("Blazing Barrier") and ((php <= br.getOptionValue("Blazing Barrier") and inCombat) or (br.isChecked("Blazing Barrier OOC") and not inCombat)) and not buff.blazingBarrier.exists() and not isCastingSpell(spell.fireball) and not buff.hotStreak.exists() and not buff.heatingUp.exists() then
