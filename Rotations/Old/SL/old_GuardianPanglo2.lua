...
local function runRotation()
    ...
    local function List_Extras()
        if br.isChecked("Auto Shapeshifts") and not br.UnitBuffID("player", 202477) then
            -- Flight Form
            if IsFlyableArea() and ((not (isInDraenor() or isInLegion())) or isKnown(191633)) and not swimming and falling > 1 and level >= 58 and br.isChecked("Travel Form Auto Shift") then
