...
--------------------
    ...
    -- Action List - Defensive
        ...
        -- Blazing Barrier
                if br.isChecked("Blazing Barrier") and php <= br.getOptionValue("Blazing Barrier") and not buff.blazingBarrier.exists() and not isCastingSpell(spell.fireball) and not buff.hotStreak.exists() and not buff.heatingUp.exists() then
...
--- In Combat Rotation ---
--------------------------
            if inCombat and profileStop==false and br.isValidUnit(units.dyn40) and br.getDistance(units.dyn40) < 40 --[[and (timedPull == true or soloPull == true)]] and not cast.current.focusedAzeriteBeam() and not cast.current.latentArcana() --[[or not isCastingSpell(293491)]] then
