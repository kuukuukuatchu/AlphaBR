...
--- In Combat - Rotations ---
-----------------------------
        if inCombat and not IsMounted() and br.isValidUnit(units.dyn40) and br.getDistance(units.dyn40) < 40 and not isCastingSpell(spell.voidTorrent) and not isCastingSpell(spell.mindBlast) and not isCastingSpell(303769) then
        -- Action List - Defensive
